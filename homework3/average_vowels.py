...
print(counting_vowels_and_consonants("Conditional")) # prints (5, 6)
...
def average_vowels_and_consonants(paragraph):
    ...
    number_of_sentences = lens(sentences)
...
print(counting_vowels_and_consonants(paragraph)) #prints (137, 219)